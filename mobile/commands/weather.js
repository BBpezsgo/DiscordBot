...
function getEmbed(data0, data1, data2, index, data3) {
    ...
    { //Tegnap
        ...
        embed
            .addField(dayName(new Date().getDay() - 1).toString(),
                `\\💧 - %\n` +
    ...
    { //Ma2
        ...
        embed
            .addField(dayName(new Date().getDay()).toString(),
    ...
    { //Holnap után
        ...
        embed
            .addField(dayName(new Date().getDay() + 2).toString(),
    ...
    { //Holnap után-után
        ...
        embed
            .addField(dayName(new Date().getDay() + 3).toString(),
